...
import { Button, Modal, ModalHeader, ModalBody, NavLink, ModalFooter, Label, Alert, Row, Col, Card } from 'reactstrap';
...
class LoginModal1 extends React.Component<ILoginModalProps> {
